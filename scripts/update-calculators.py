...
# (ファイル名, 番号, 表示名)
# ★名前の付け方（2026-07-16 森本さん確定）: 企業向け（01顧客・02採用・04技能承継）は
#   危機感を共有しやすい強い名前（時限爆弾・消滅）のまま。学校・介護・財政など
#   暮らしのコミュニティに関わるものは、結論を先取りしない中立の名前（分岐点・支え手）。
#   判断基準は「読者が企業か、当事者コミュニティか」。不揃いは方針であり、揺れではない。
